...
<head>
    ...
    <link href="/redcenterold/RedCenter/Home/Public/css/login.css" rel="stylesheet">
</head>
...
<form id="form_login" class="container-center form-horizontal font_fa" action="<?php echo U('Home/Login/loginHandle', '', '');?>" method="post">
    ...
    <div class="form-group h4">
        ...
        <div class="col-md-9 col-lg-9 col-sm-9 col-xs-9">
            <input name="user" type="text" id="inputUser" class="form-control" autofocus>
        </div>
    </div>
    <div class="form-group h4">
        <label for="inputPassword" class="form_font control-label col-md-3 col-lg-3 col-sm-3 col-xs-3">密码：</label>
        <div class="col-md-9 col-lg-9 col-sm-9 col-xs-9">
            <input name="password" type="password" id="inputPassword" class="form-control" autofocus>
        </div>
    </div>
    ...
    <div class="checkbox clearfix">
        ...
        <a href="#" class="form_forget">忘记密码?</a>
    </div>
...
<script type="text/javascript" src="/redcenterold/RedCenter/Home/Public/js/login.js"></script>
</html>