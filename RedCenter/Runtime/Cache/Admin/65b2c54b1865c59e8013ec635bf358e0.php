...
<link rel="stylesheet" href="/RedCenter/RedCenter/Admin/Public/css/node.css" type="text/css" />
        <div class="pageheader">
            <h1 class="pagetitle">用户管理</h1>
            <span class="pagedesc">修改权限</span>
            <a href="<?php echo U('Admin/Rbac/addNode');?>" class="btn btn_bulb" style="float: right; margin: 0 20px;"><span>添加模块</span></a>
        </div><!--pageheader-->
