...
<div class="bodywrapper">
    ...
    <div class="header">
        <ul class="headermenu">
            <li><a href="<?php echo U('Admin/Index/index');?>"><span class="icon icon-flatscreen"></span>首页</a></li>
            <li class="current"><a href="<?php echo U('Admin/Rbac/index');?>"><span class="icon icon-pencil"></span>用户权限</a></li>
    ...
    <div class="vernav2 iconmenu">
        <ul>
            <li class="current"><a href="#formsub" class="editor">用户权限</a>
                <span class="arrow"></span>
                <ul id="formsub">
                    <li><a href="<?php echo U('Admin/Rbac/index');?>">用户列表</a></li>
                    <li class="current"><a href="<?php echo U('Admin/Rbac/role');?>">权限列表</a></li>
    ...
    <div class="centercontent">
        ...
        <div id="contentwrapper" class="contentwrapper">
            ...
            <div id="updates" class="subcontent">
                ...
                <form class="stdform stdform2" method="post" action="<?php echo U('Admin/Rbac/addRoleHandle');?>">
                    <p>
                        <label>权限名称</label>
                    ...
                    <p>
                        <label>权限描述</label>
                        <span class="field"><input type="text" name="remark" id="lastname2" class="longinput" /></span>
                    </p>
