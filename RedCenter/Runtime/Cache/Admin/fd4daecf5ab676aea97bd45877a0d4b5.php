...
<div class="bodywrapper">
    ...
    <div class="centercontent">
        ...
        <div class="pageheader">
            ...
            <span class="pagedesc">用户列表</span>
            <a href="<?php echo U('Admin/Rbac/addUser');?>" class="btn btn_bulb" style="float: right; margin: 0 20px;"><span>新增用户</span></a>
            <!--<ul class="hornav">-->
                ...
                <div class="notibar announcement">
                    <div id="search">
                        <form action="<?php echo U('Admin/Rbac/index');?>" method="post">
                            <button id="search_btn" class="btn btn_search radius50">
                                <span>Search</span>
                            </button>
                            <input name="search" id="search_input" type="text" placeholder="根据学号查询">
                        </form>
                    </div>
                    <table cellpadding="0" cellspacing="0" border="0" id="table2" class="stdtable stdtablecb">
                        ...
                        <tbody>
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="gradeA">
                                <td><?php echo ($vo["stu_num"]); ?></td>
                                <td><?php echo ($vo["stu_idcard"]); ?></td>
                                <td><?php echo ($vo["real_name"]); ?></td>
                                <td class="center">
                                    <?php if(is_array($vo['role'])): $i = 0; $__LIST__ = $vo['role'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ro): $mod = ($i % 2 );++$i; echo ($ro["remark"]); endforeach; endif; else: echo "" ;endif; ?>
                                </td>
                                <td class="center"><a href="<?php echo U('Admin/Rbac/setRole', array('uid' => $vo[id]));?>" class="edit">修改信息</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo U('Admin/Rbac/deleteUser', array('uid' => $vo[id]));?>" class="delete">删除</a></td>
                            </tr><?php endforeach; endif; else: echo "" ;endif; ?>
                        </tbody>
                    </table>
                    <div class="dataTables_paginate"><?php echo ($show); ?></div>
